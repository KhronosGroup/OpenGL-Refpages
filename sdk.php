<?php
$static_title = 'Khronos OpenGL&reg; Reference Pages - Tools and Libraries';
$static_breadcrumb = array(
    '/registry/' => 'Registry',
    'NOLINK' => 'OpenGL Reference Pages - Tools and Libraries'
);
include_once("../../assets/static_pages/khr_page_top.php");
?>

<h1 class="pagetitle"> OpenGL&reg; and OpenGL&reg; ES Tools and Libraries </h1>
<div id="mainformat">


<h1 style="text-align:center"> OpenGL&reg; and OpenGL&reg; ES Tools and Libraries </h1>

<p> Khronos used to host an &quot;SDK&quot; area, primarily composed of
    links to external projects, with some hosted content on behalf of those
    projects. This area was not kept up to date, and aside from a few
